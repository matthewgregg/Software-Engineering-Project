...
public class SetupGame {
	...
	public static List<Player> playerCreation(Scanner scanner) {
		...
		// playerNameCheck(new Player(playerID, name)), but I haven't investigated that
		// approach!
		return players;
	}
	/*
	 * // Just have a play with handling the name check needs work! // I only spent
	 * 15 minutes to break up my revision - if anyone wants to progress it feel
	 * free! public void playerNameCheck(String name, int playerID) { //
	 * 
	 * for(Player player: players) { if(player.getName().equalsIgnoreCase(name) ||
	...
	public static ArrayList<Square> setupBoard() {
		...
		SystemSquare ss1 = new SystemSquare("Square 1", 1, "System 1", SystemName.SYSTEM_NAME_1, 2, 300, 200,
				new int[] { 10, 20, 30, 90, 150 });

		SystemSquare ss2 = new SystemSquare("Square 2", 2, "System 1", SystemName.SYSTEM_NAME_1, 2, 300, 200,
				new int[] { 10, 20, 30, 90, 150 });

		SystemSquare ss3 = new SystemSquare("Square 3", 3, "System 1", SystemName.SYSTEM_NAME_2, 2, 300, 200,
				new int[] { 10, 20, 30, 90, 150 });

		SystemSquare ss4 = new SystemSquare("Square 4", 4, "System 1", SystemName.SYSTEM_NAME_2, 2, 300, 200,
				new int[] { 10, 20, 30, 90, 150 });

		SystemSquare ss5 = new SystemSquare("Square 5", 5, "System 1", SystemName.SYSTEM_NAME_2, 2, 300, 200,
				new int[] { 10, 20, 30, 90, 150 });

		Square sq2 = new Square("Nothing", 6, "Missed launch window");

		SystemSquare ss6 = new SystemSquare("Square 6", 7, "System 1", SystemName.SYSTEM_NAME_3, 2, 300, 200,
				new int[] { 10, 20, 30, 90, 150 });

		SystemSquare ss7 = new SystemSquare("Square 7", 8, "System 1", SystemName.SYSTEM_NAME_3, 2, 300, 200,
				new int[] { 10, 20, 30, 90, 150 });

		SystemSquare ss8 = new SystemSquare("Square 8", 9, "System 1", SystemName.SYSTEM_NAME_3, 2, 300, 200,
				new int[] { 10, 20, 30, 90, 150 });

		SystemSquare ss9 = new SystemSquare("Square 9", 10, "System 1", SystemName.SYSTEM_NAME_4, 2, 300, 200,
				new int[] { 10, 20, 30, 90, 150 });

		SystemSquare ss10 = new SystemSquare("Square 10", 11, "System 1", SystemName.SYSTEM_NAME_4, 2, 300, 200,
				new int[] { 10, 20, 30, 90, 150 });
